        ...
        return (
            <ScrollView>
                ...
                <View style={styles.formRow}>
                    ...
                    <Button onPress={() => this.setState({ showCalendar: !this.state.showCalendar })} title={this.state.date.toLocaleDateString('en-US')} color="#5637DD" accessibilityLabel="Tap me to select a reservation date" />
                </View>
                ...
                <View style={styles.formRow}>
                    <Button onPress={() => this.handleReservation()} title="Search" color="#5637DD" accessibilityLabel="Tap me to search for available campsites to reserve" />
                </View>
            </ScrollView>
        );
    }
